...
//#define MB_N_C_0x 0 //Max coils for Modbus is 100 due to limited memory
//#define MB_N_I_1x 0 //Max inputs for Modbus is 100 due to limited memory
//#define MB_N_IR_3x 0 //Max 16 bit input registers is 64 due to limited memory
...
public:
    ...
    uint8_t Exception;
private:
    uint8_t ByteReceiveArray[TAMANHO_BUFFER];
    uint8_t ByteSendArray[TAMANHO_BUFFER];
    uint8_t SaveArray[TAMANHO_BUFFER];
    int FC;
    void SetFC(int fc);
