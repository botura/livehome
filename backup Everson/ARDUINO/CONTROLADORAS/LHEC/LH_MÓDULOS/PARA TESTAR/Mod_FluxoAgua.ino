...
void monitoringfluxoagua() 
{
  ...
  if((millis() - tempo_antes) > 1000){
    ...
    Serial.print(fluxo);
    Mb.R[44]=(fluxo); //Informa para o Modbus o fluxo da água
    ...
    Mb.R[45]=(volume_total); //Informa para o Modbus o volume total consumido
    Serial.println(" L");
    Serial.println();
